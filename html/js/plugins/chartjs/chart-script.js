...
function update() {
	nReloads++;
	total_seconds = 3*l;
	var dataa_lbl =  nReloads + "minutes";
	var x = Math.floor(Math.random() * (max - min + 1)) + min;
	var y = Math.floor(Math.random() * (max - min + 1)) + min;
	trendingLineChart.addData([x, y], dataa_lbl);
...
*/
var radarChartData = {
	labels: ["Mechanics", "Heat", "Optics", "Modern Physics", "Electricity and Magnetism"],
	datasets: [
		{
			label: "First dataset",
...
*/
var lineChartData = {
	labels : ["1 day ago","2days ago","3 days ago","4 days ago","5 days ago","6 days ago", "7 days ago"],
	datasets : [
		{
			label: "My dataset",
