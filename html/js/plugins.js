/*================================================================================
  Item Name: Meroanswer - Material Design Admin Template
  Version: 2.1
  Author: GeeksLabs
...
$(function() {
  ...
  * Plugin initialization
  ...
  // Floating-Fixed table of contents (Meroanswer pushpin)
  if ($('nav').length) {
    $('.toc-wrapper').pushpin({
      top: $('nav').height()
    });
...
//added by sujit maharjan

$(".content_fullscreen").click(function()
                      {
                                var elem = document.getElementById('presentation_frame');
